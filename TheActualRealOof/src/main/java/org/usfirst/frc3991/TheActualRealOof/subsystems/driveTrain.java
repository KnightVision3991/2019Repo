...
public class driveTrain extends PIDSubsystem {
    ...
    public driveTrain() {
        ...
        for(int i = (RobotMap.driveTrainMotors.length/2) + 1; i < RobotMap.driveTrainMotors.length; i++) {
            driveTrainMotors[i].set(ControlMode.Follower, driveTrainMotors[(RobotMap.driveTrainMotors.length/2)].getDeviceID());
        }
    ...
    public void initDefaultCommand() {
        ...
        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_
    ...
    public void manualDrive(double oof){
        driveTrainMotors[0].set(ControlMode.PercentOutput, -oof);
        driveTrainMotors[1].follow(driveTrainMotors[0]);
        driveTrainMotors[2].follow(driveTrainMotors[0]);
        driveTrainMotors[3].set(ControlMode.PercentOutput, oof);
  ...
  public void usePIDOutput(double output) {
    ...
    double rot = Robot.oi.getJoystick1().getRawAxis(0);
    ...
    //LEFT SIDE
    driveTrainMotors[0].set(ControlMode.Velocity, 100); //USE THIS TO SET DESIRED TARGET FOR PID TO REACH TOO
    


    //RIGHT SIDE 
    driveTrainMotors[(RobotMap.driveTrainMotors.length/2)].set(ControlMode.Velocity, 100); //USE THIS TO SET DESIRED TARGET FOR PID TO REACH TOO

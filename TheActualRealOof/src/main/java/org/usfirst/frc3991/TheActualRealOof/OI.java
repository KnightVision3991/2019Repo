...
public class OI {
    ...
    public OI() {
        ...
        DPAD_DOWN.whenPressed(new armToIntakePos());
        DPAD_RIGHT.whenPressed(new armToOuttakeFrontPos());
        DPAD_LEFT.whenPressed(new armToOuttakeBackPos());
        DPAD_DOWN.whenPressed(new armToDefence());

...
public class OI {
    ...
    public Button LB; //Low Shift
    public Button RB; //High Shift
    public Button STRT;
    public Button BACK;
    public Button X;
    public Button A;
    public Button B;
    public Button Y;
    public POVButton d_up;
	public POVButton d_down;
	public POVButton d_left;
	public POVButton d_right;
    ...
    public OI() {
        ...
        LB = new JoystickButton(joystick1, 5); //Low Shift
        RB = new JoystickButton(joystick1, 6); //High Shift
        STRT = new JoystickButton(joystick1, 8);
        ...
        d_up = new POVButton(joystick1,0);
	    d_down = new POVButton(joystick1,4);
	    d_left = new POVButton(joystick1,6);
	    d_right = new POVButton(joystick1,2);
